...
import com.minimajack.v8.metadata.inner.classes.attributes.*;
...
import com.minimajack.v8.metadata.inner.classes.configuration.common.*;
...
import com.minimajack.v8.metadata.inner.classes.configuration.main.*;
...
public class InnerClassTransformer implements AbstractTransformer<V8InnerClass> {
    ...
    static {
        classbyUUID.put(FORMS_SECTION, FormList.class);
        classbyUUID.put(TEMPLATE_SECTION, TemplateList.class);
        classbyUUID.put(TABULAR_ATTRIBUTES_SECTION, AttributesList.class);
        classbyUUID.put(DATAPROCESSOR_TABULAR_ATTRIBUTES_SECTION, AttributesList.class);
        classbyUUID.put(REPORT_TABULAR_ATTRIBUTES_SECTION, AttributesList.class);
        classbyUUID.put(ATTRIBUTES_SECTION, AttributesList.class);
        classbyUUID.put(TABULAR_SECTION, TabularList.class);
        classbyUUID.put(ROLE_SECTION, Roles.class);
        classbyUUID.put(COMMON_TEMPLATES_SECTION, CommonTemplates.class);
        classbyUUID.put(COMMON_MODULES_SECTION, CommonModules.class);
        classbyUUID.put(SCHEDULED_JOBS_SECTION, ScheduledJobs.class);
        classbyUUID.put(COMMON_ATTRIBUTES_SECTION, CommonAttributes.class);
        classbyUUID.put(SESSION_PARAMS_SECTION, SessionParams.class);
        classbyUUID.put(FUNC_OPTIONS_PARAMS_SECTION, FunctionalOptionParams.class);
        classbyUUID.put(HTTP_SERVICES_SECTION, HttpServices.class);
        classbyUUID.put(SUBSYSTEMS_SECTION, Subsystems.class);
        classbyUUID.put(INTERFACES_SECTION, Interfaces.class);
        classbyUUID.put(STYLES_SECTION, Styles.class);
        classbyUUID.put(FILTER_CRITERIA_SECTION, FilterCriteria.class);
        classbyUUID.put(SETTINGS_STORAGES_SECTION, SettingsStorages.class);
        classbyUUID.put(EVENT_SUBSCRIPTIONS_SECTION, EventSubscriptions.class);
        classbyUUID.put(STYLE_ITEMS_SECTION, StyleItems.class);
        classbyUUID.put(COMMON_PICTURES_SECTION, CommonPictures.class);
        classbyUUID.put(EXCHANGE_PLANS_SECTION, ExchangePlans.class);
        classbyUUID.put(WEB_SERVICES_SECTION, WebServices.class);
        classbyUUID.put(LANGUAGES_SECTION, Languages.class);
        classbyUUID.put(FUNCTIONAL_OPTIONS_SECTION, FunctionalOptions.class);
        classbyUUID.put(DEFINED_TYPES_SECTION, DefinedTypes.class);
        classbyUUID.put(XDTO_PACKAGES_SECTION, XdtoPackages.class);
        classbyUUID.put(WS_REFERENCES_SECTION, WsReferences.class);
        classbyUUID.put(CONSTANTS_SECTION, Constants.class);
        classbyUUID.put(DOCUMENTS_SECTION, Documents.class);
        classbyUUID.put(COMMON_FORMS_SECTION, CommonForms.class);
        classbyUUID.put(INFORMATION_REGISTERS_SECTION, InformationRegisters.class);
        classbyUUID.put(COMMAND_GROUPS_SECTION, CommandGroups.class);
        classbyUUID.put(COMMON_COMMANDS_SECTION, CommonCommands.class);
        classbyUUID.put(DOCUMENT_NUMERATORS_SECTION, DocumentNumerators.class);
        classbyUUID.put(DOCUMENT_JOURNALS_SECTION, DocumentJournals.class);
        classbyUUID.put(REPORTS_SECTION, Reports.class);
        classbyUUID
                .put(CHARTS_OF_CHARACTERISTIC_TYPES_SECTION, ChartsOfCharacteristicTypes.class);
        classbyUUID.put(ACCUMULATION_REGISTERS_SECTION, AccumulationRegisters.class);
        classbyUUID.put(SEQUENCES_SECTION, Sequences.class);
        classbyUUID.put(DATA_PROCESSORS_SECTION, DataProcessors.class);
        classbyUUID.put(CATALOGS_SECTION, Catalogs.class);
        classbyUUID.put(ENUMS_SECTION, Enums.class);
        classbyUUID.put(CHARTS_OF_ACCOUNTS_SECTION, ChartsOfAccounts.class);
        classbyUUID.put(ACCOUNTING_REGISTERS_SECTION, AccountingRegisters.class);
        classbyUUID.put(CHARTS_OF_CALCULATION_TYPES_SECTION, ChartsOfCalculation.class);
        classbyUUID.put(CALCULATION_REGISTERS_SECTION, CalculationRegisters.class);
        classbyUUID.put(TASKS_SECTION, Tasks.class);
        ...
        classbyUUID.put(CALCULATION_CONFIGURATION_BLOCK, CalculationConfiguraionMetaData.class);
        classbyUUID
        ...
        classbyUUID.put(COMMAND_LIST, CommandList.class);
        classbyUUID.put(TABULARS, TabularList.class);
        classbyUUID.put(ATTRIBUTES, AttributesList.class);
        classbyUUID.put(FORMS, FormList.class);
        classbyUUID.put(TABULAR_DOCUMENTS, TabularList.class);
        classbyUUID.put(ATTRIBUTES_DOCUMENTS, AttributesDocumentList.class);
        classbyUUID.put(COMMAND_LIST_DOCUMENTS, CommandList.class);
        classbyUUID.put(TEMPLATES_SECTION_DOCUMENTS, TemplateList.class);
        classbyUUID.put(UNK_REGISTERS, FormList.class);
        classbyUUID.put(RESOURCE_REGISTERS, ResourceList.class);
        classbyUUID.put(DIMENSION_REGISTERS, DimensionList.class);
        classbyUUID.put(ATTRIBUTES_REGISTERS, AttributesRegistersList.class);
        classbyUUID.put(FORMS_REGISTERS, FormList.class);
        classbyUUID.put(RESOURCE_INFORMATION_REGISTERS, InformationResourceList.class);
        classbyUUID.put(DIMENSION_INFORMATION_REGISTERS, InformationDimensionList.class);
        classbyUUID.put(FORMS_INFORMATION_REGISTERS, FormList.class);
        classbyUUID.put(ATTRIBUTES_INFORMATION_REGISTERS, AttributesRegistersList.class);
        classbyUUID.put(COMMANDS_INFORMATION_REGISTERS, CommandListMetaDataObject.class);
        classbyUUID.put(ATTRIBUTES_REPORTS, AttributesList.class);
        classbyUUID.put(FORM_REPORTS, FormList.class);
        classbyUUID.put(TABULARS_REPORTS, TabularList.class);
        classbyUUID.put(COMMANDS_REPORTS, CommandListMetaDataObject.class);
        classbyUUID.put(COMMANDS_DATA_PROCESSORS, CommandListMetaDataObject.class);
        classbyUUID.put(UNK1_ENUM, FormList.class);
        classbyUUID.put(UNK2_ENUM, FormList.class);
        classbyUUID.put(VALUES_ENUM, EnumList.class);
        classbyUUID.put(ATTRIBUTES_EXCHANGE_PLANS, AttributesList.class);
        classbyUUID.put(TABULARS_EXCHANGE_PLANS, TabularList.class);
        classbyUUID.put(FORMS_EXCHANGE_PLANS, FormList.class);
        classbyUUID.put(COMMANDS_EXCHANGE_PLANS, CommandList.class);
        classbyUUID.put(FORMS_FILTER_CRITERIA, FormList.class);
        classbyUUID.put(COMMANDS_FILTER_CRITERIA, CommandList.class);
        classbyUUID.put(DATA_SEQUENCES, SequencesDataList.class);
        classbyUUID.put(FORMS_SETTING_STORAGES, FormList.class);
        classbyUUID.put(FORMS_TASKS, FormList.class);
        classbyUUID.put(ATTRIBUTES_TASKS, AttributesList.class);
        classbyUUID.put(ATTRIBUTES_ADDRESS_TASKS, AttributesAddressList.class);
        classbyUUID.put(TABULARS_TASKS, TabularList.class);
        classbyUUID.put(COMMANDS_TASKS, CommandList.class);
        classbyUUID.put(OPERATION_WEB_SERVICE, WebServiceList.class);
        classbyUUID.put(OPERATION_PARAMS_WEB_SERVICE, OperationParams.class);
        classbyUUID.put(ATTRIBUTES_ACCOUNTING, AttributesAddressList.class);
        classbyUUID.put(RESOURCE_ACCOUNTING, AccountingResourceList.class);
        classbyUUID.put(COMMANDS_ACCOUNTING, CommandListMetaDataObject.class);
        classbyUUID.put(DIMENSION_ACCOUNTING_REGISTERS, DimensionList.class);
        classbyUUID.put(FORMS_ACCOUNTING_REGISTERS, FormList.class);
        classbyUUID.put(DIMENSION_CALCULATION_REGISTERS, CalculationDimensionList.class);
        classbyUUID.put(UNK1_CALCULATION_REGISTERS, FormList.class);
        classbyUUID.put(RESOURCE_CALCULATION_REGISTERS, CalculationResourceList.class);
        classbyUUID.put(UNK2_CALCULATION_REGISTERS, FormList.class);
        classbyUUID.put(UNK3_CALCULATION_REGISTERS, FormList.class);
        classbyUUID.put(ATTRIBUTES_CALCULATION_REGISTERS, CalculationAttributesList.class);
        classbyUUID.put(TABULAR_CHART_ACCOUNT, TabularList.class);
        classbyUUID.put(COMMANDS_CHART_ACCOUNT, CommandList.class);
        classbyUUID.put(FORMS_CHART_ACCOUNT, FormList.class);
        classbyUUID.put(ATTRIBUTES_CHART_ACCOUNT, AttributesList.class);
        classbyUUID.put(FLAGS_CHART_ACCOUNT, AccountingFlags.class);
        classbyUUID.put(EXT_DIMENTION_FLAGS_CHART_ACCOUNT, ExtDimensionAccountingFlags.class);
        classbyUUID.put(TABULAR_CHART_CALCULATION, TabularList.class);
        classbyUUID.put(ATTRIBUTES_CHART_CALCULATION, AttributesList.class);
        classbyUUID.put(COMMANDS_CHART_CALCULATION, CommandList.class);
        classbyUUID.put(FORMS_CHART_CALCULATION, FormList.class);
        classbyUUID.put(TABULAR_CHART_CHARACTERISTICS, TabularList.class);
        classbyUUID
                .put(ATTRIBUTES_CHART_CHARACTERISTICS, ChartsOfCharacteristicTypesAttributesList.class);
        classbyUUID.put(COMMANDS_CHART_CHARACTERISTICS, CommandList.class);
        classbyUUID.put(FORMS_CHART_CHARACTERISTICS, FormList.class);
        classbyUUID.put(COLUMNS_DOCUMENT_JOURNAL, ColumnList.class);
        classbyUUID.put(COMMANDS_DOCUMENT_JOURNAL, CommandListMetaDataObject.class);
        classbyUUID.put(FORMS_DOCUMENT_JOURNAL, FormList.class);
        classbyUUID.put(FORMS_BUSINESS_PROCESS, FormList.class);
        classbyUUID.put(COMMANDS_BUSINESS_PROCESS, CommandList.class);
        classbyUUID.put(ATTRIBUTES_BUSINESS_PROCESS, AttributesList.class);
        classbyUUID.put(TABULARS_BUSINESS_PROCESS, TabularList.class);
        classbyUUID.put(URL_TEMPLATES_HTTP_SERVICE, UrlTemplates.class);
        classbyUUID.put(METHODS_HTTP_SERVICE, HttpMethods.class);
        classbyUUID.put(ENUM_FILL_CHEKING, FillChecking.class);
        classbyUUID.put(LINK_BY_TYPE, LinkByType.class);
        classbyUUID.put(CREATE_ON_INPUT, UnkObjectUuidInt.class);
        classbyUUID.put(MULTILANGUAGE_STRING, V8Synonym.class);
        classbyUUID.put(METADATA_OBJECT, MetaDataObjectLink.class);
        classbyUUID.put(ENUM_USE_QUICK_CHOICE, UnkObjectUuidInt.class);
        classbyUUID.put(ENUM_CHOICE_HISTORY_ON_INPUT, ChoiceHistoryOnInput.class);
        classbyUUID.put(ENUM_FULL_TEXT_SEARCH, UnkObjectUuidInt.class);
        classbyUUID.put(CHOICE_PARAMETER_LINKS, ChoiceParameterLinks.class);
        classbyUUID.put(CHOICE_PARAMETERS, ChoiceParameters.class);
        classbyUUID.put(PREDEFINED_TYPE_11, UnkObjectIntUuidUuid.class);
        classbyUUID.put(FIXED_ARRAY, FixedArray.class);
        classbyUUID.put(ENUM_APPLICATION_USE_PURPOSE, ApplicationUsePurpose.class);
        classbyUUID
                .put(REQUIRED_MOBILE_APPLICATION_PERMISSIONS, RequiredMobileApplicationPermissions.class);
        classbyUUID.put(FUNCTIONAL_OPTION_VALUE, FunctionalOptionContentItem.class);
        classbyUUID.put(COMPOSITE_ID, UnkObjectIntNotReqUuid.class);
        classbyUUID.put(CHARACTERISTICS_DESCRIPTION, CharacteristicsDescription.class);
        classbyUUID.put(STANDART_PERIOD, StandartPeriod.class);
        classbyUUID.put(COLOR, Color.class);
        classbyUUID.put(FONT, Font.class);
        classbyUUID.put(BORDER, Border.class);
    ...
    @Override
    public V8InnerClass read(final ByteBuffer buffer) {
        buffer.mark();
        V8InnerClass innerClass = new V8InnerClass();
        final UUID classUUID = V8Reader.read(UUID.class, buffer);
        innerClass.setClassUUID(classUUID);
        if (classbyUUID.containsKey(classUUID)) {
            V8Reader.readChar(buffer, ',');
            innerClass.setValue(V8Reader.read(classbyUUID.get(classUUID), buffer));
        } else {
    ...
    public void write(Object object, SerializedOutputStream buffer) {
        V8Reader.write(((V8InnerClass)object).getClassUUID(), buffer);
        buffer.putComa();
        V8Reader.write(((V8InnerClass)object).getValue(), buffer);
    }
}
